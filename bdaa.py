...
\033[1;97m Owner  : AHMADO x Wasi :/

\033[1;97m GitHub : AHMADO-404 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/AHMADO-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=AHMADO-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=AHMADO-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .AHMADO')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.AHMADO','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.AHMADO', 'r').read().splitlines()
    ...
    def start(user):
     ...
     try:
        ...
        for pword in totalpass:              
            ...
            heads = "Mozilla/5.0 (Linux; Android 11; V2050 Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/386.0.0.35.108;]"
    ...
    def start(user):
     ...
     try:
        ...
        for pword in totalpass:              
            ...
            heads = "Mozilla/5.0 (Linux; Android 12; Infinix X676C Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.65 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/404.0.0.35.70;]"
    ...
    def start2(user):
      ...
      try:
        ...
        for pword in totalpass:
            ...
            heads = "Dalvik/2.1.0 (Linux; U; Android 6; PS1127PL Build/QP1A.899777.259) [FBAN/FB4A;FBAV/312.0.0.45.117;FBBV/281505338;FBDM/{density=4.0,width=1440,height=2392};FBLC/en_US;FBRV/0;FBCR/VIVO;FBMF/LGE;FBBD/lge;FBPN/com.facebook.katana;FBDV/LG-H815;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
